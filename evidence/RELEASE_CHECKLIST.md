...
- [x] Direct Mode tests include mocked web, screenshot and JSON LLM responses; GitHub Actions validation passes with `35 passed, 2 skipped` and the documented loader compatibility shim.
