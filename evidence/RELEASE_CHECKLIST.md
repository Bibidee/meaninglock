...
- [x] Direct Mode tests include mocked web, screenshot and JSON LLM responses; final CI run `33335769224` reports `35 passed, 2 skipped` with the documented loader compatibility shim.
